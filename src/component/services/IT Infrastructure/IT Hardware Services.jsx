...
export const IThomePage = () => {
  ...
  const faqs = [
    {
      question: "What are IT Hardware Services?",
      answer:
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            <h2 class="text-base/7 font-semibold text-indigo-600 tracking-[.35em] uppercase">
              Leading IT Hardware Solution Provider
            </h2>
            ...
            <p class="mt-6 text-lg/8 text-gray-600">
              We provide comprehensive IT Hardware & Software solutions tailored
              to meet your business needs. Whether you’re upgrading your{" "}
              <span class="font-semibold text-indigo-600">
                IT infrastructure
              </span>
              , deploying new software, or need ongoing support, our expert team
              ensures seamless integration and optimal performance.
              <br className="mb-6" />
              Trust us to deliver reliable and scalable solutions that keep your
              ...
              <div class="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
                <ul class="mt-8 space-y-8 text-gray-600">
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      <strong class="font-semibold text-gray-800">
                        Leverage Deep Buying Power
                      </strong>
                      <br /> Our strong partnerships with leading manufacturers
                      enable us to provide the latest technology solutions
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      <strong class="font-semibold text-gray-800">
                        Convenient Self-Service Procurement
                      </strong>
                      <br /> Purchase hardware, licenses, and services through
                      our intuitive e-procurement platform, streamlining the
                      acquisition process for maximum efficiency.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br /> Receive precisely configured IT assets with our
                      comprehensive services, including warehousing, asset
                      tagging, and kitting, tailored to your specifications.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      <strong class="font-semibold text-gray-800">
                        Seamless Hardware and Software Procurement
                      </strong>
                      <br />
                      Acquire both hardware products and software licenses
                      through our self-service platform, ensuring integrated
                      solutions and streamlined procurement.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Our dedicated account managers offer personalized support,
                      connecting you to exclusive service provider offerings and
                      revenue programs from top vendors.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div class="mx-auto text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p class="mt-6 text-pretty text-lg/8 text-gray-300">
                Revolutionize your data center. Our hardware optimization
                solutions will help your business run smarter so you can serve
                your customers more effectively. Whether you’re updating your
                infrastructure to accommodate increasing demand or creating
                solution bundles to meet the needs of your customers, our deep
                relationships and buying power can help.
              </p>
            ...
            <div class="relative mt-16 h-80 lg:mt-8">
              <img
                ...
                src="https://cubezix.com/wp-content/uploads/2024/02/IT-Hardware-and-Software-solutions.webp"
                alt="App screenshot"
                width="1824"
                height="1080"
              />
