...
export const IThomePage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "In Dubai, common office telephone systems include: <br/> <br/> <span class=' font-semibold text-indigo-600'>Traditional PBX (Private Branch Exchange):</span> Uses landlines for internal and external communication. <br/> <span class=' font-semibold text-indigo-600'>IP PBX:</span> Routes calls via the internet rather than landlines. <br/> <span class=' font-semibold text-indigo-600'>VoIP (Voice over IP):</span> Uses internet protocols for voice communication, offering flexibility and lower costs. <br/> <span class=' font-semibold text-indigo-600'>Cloud-based Phone Systems: </span>Managed online, allowing scalability and remote access.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "<span class=' font-semibold text-indigo-600'>Scalability:</span> Easily add or remove users as your business grows. <br/> <span class=' font-semibold text-indigo-600'>Remote Access:</span> Employees can make and receive calls from anywhere. <br/> <span class=' font-semibold text-indigo-600'>Cost Efficiency:</span> No need for extensive hardware or maintenance costs. <br/> <span class=' font-semibold text-indigo-600'>Advanced Features:</span> Includes call recording, auto attendants, voicemail to email, etc.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer:
        "To choose the right system, consider: <br/> <br/> The size of your business and the number of employees. <br/> Your communication needs (local vs. international calls, conferencing, etc.). <br/> The features you need (voicemail, call forwarding, call recording). <br/> Whether you need remote or mobile access. <br/> Budget and scalability needs.",
    },
  ];
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            <h2 class="text-base/7 font-semibold text-indigo-600 tracking-[.35em] uppercase">
              PABX System Installation in Duba
            </h2>
                ...
                <ul class="mt-8 space-y-8 text-gray-600">
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br /> Save on labor costs while maintaining seamless
                      internal communication with a system that offers extension
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Onetech offers expert installation and maintenance of IP
