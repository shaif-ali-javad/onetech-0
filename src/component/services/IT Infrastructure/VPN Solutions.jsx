...
export const IThomePage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "VPNs enhance data privacy by encrypting your internet traffic, making it unreadable to third parties or hackers. This ensures that sensitive business information remains confidential, even when accessed over public networks.",
    },
    {
      question: "What is the difference between a VPN and a firewall?",
      answer:
        "A VPN secures and encrypts internet connections, allowing for safe access to private networks, while a firewall monitors and controls incoming and outgoing network traffic based on security rules. Both work together to enhance overall network security.",
    },
  ];
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-36">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-pretty text-lg font-medium text-gray-600 sm:text-xl/8">
                Our VPN solutions offer secure, remote access for businesses in
                Dubai, enhancing connectivity from anywhere.
              </p>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-6 text-lg/8 text-gray-600">
              ...
              , ensuring secure connectivity for remote and branch offices.
            </p>
          </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-auto text-center">
            ...
            <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
              We will understand your requirements and help you implement VPN
              ...
              <div class="lg:pr-4">
                <div class="lg:max-w-lg">
                  ...
                  <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-800 sm:text-5xl">
                    Features of Our VPN Solutions
                  </h1>
                  <p class="mt-6 text-xl/8 text-gray-600">
                    Explore our VPN solutions offering secure, scalable features
                    for efficient, multi-location operations and management.
                  </p>
                </div>
              </div>
            </div>
                ...
                <ul class="mt-8 space-y-8 text-gray-600">
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Establish secure connections between headquarters, branch
                      offices, and remote users for seamless operations.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Manage and support devices remotely without disrupting
                      workflow, ensuring uninterrupted productivity.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Create secure, encrypted connections between endpoints to
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Monitor user activity and network anomalies to detect and
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Update and enforce compliance protocols across all devices
                      and environments simultaneously for consistency.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Control access to your business network, ensuring only
                      authorized users can connect securely.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Provide secure, customizable access to web and server
