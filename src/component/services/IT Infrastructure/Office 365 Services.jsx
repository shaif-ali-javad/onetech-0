...
export const IThomePage = () => {
  ...
  const faqs = [
    {
      question: "What is Office 365 and how can it benefit my business?",
      answer:
        "Microsoft Office 365 is a set of productivity tools that include: <br/> <br/> <span class='text-base/7 font-semibold text-indigo-600'> Word - A Word Processing Application </span> <br/> <span class='text-base/7 font-semibold text-indigo-600'> Excel - A Spreadsheet Editor </span> <br/> <span class='text-base/7 font-semibold text-indigo-600'> Powerpoint - A Presentation Program </span> <br/> <span class='text-base/7 font-semibold text-indigo-600'> Outlook - An Email Client </span> <br/> <span class='text-base/7 font-semibold text-indigo-600'> Teams - An Internal Messaging Platform </span> <br/> <br/> And many more alongside cloud storage offered via Microsoft OneDrive. Together, this suite of powerful applications enables teams to effectively collaborate, communicate & work together from virtually anywhere.",
    },
    {
      question: "What are the key features of Office 365 for businesses?",
      answer:
        "Alongside offering the complete suite of Microsoft’s Productivity Tools, an Office 365 License provides additional features including complete end-to-end data protection & regular updates that come with new features, bug fixes, and security patches to ensure your business remains secure and productive.",
    },
    {
      question: "Can Office 365 be customized to suit my business needs?",
      answer:
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-36">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-800/10 hover:ring-gray-800/20 tracking-[.35em] uppercase">
                Connectivity with Expert Microsoft 365 Solutions
            ...
            <div className="text-center">
              <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-800 sm:text-7xl">
                Microsoft 365 Partner in Dubai
              </h1>
              <p className="mt-8 text-pretty text-lg font-medium text-gray-600 sm:text-xl/8">
                As a Microsoft 365 Partner in Dubai, we provide state-of-the-art
                solutions to boost your connectivity.
              </p>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-6 text-lg/8 text-gray-600">
              ...
              , including migration, setup, and 24/7 support. Experience
              seamless collaboration, robust security, and enhanced productivity
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-auto text-center">
            <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">
              Empowering the Secure Modern Workplace with Microsoft 365
            </h2>
            <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
              Microsoft 365 combines Office 365, Windows 10, and Enterprise
              Mobility + Security into one package. Contact Now!
            </p>
          </div>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
                ...
                <ul class="mt-8 space-y-8 text-gray-600">
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Drive faster user adoption and integrate Office 365
                      extensions to managed services for maximum efficiency.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Our Office 365 experts integrate your Cloud solution into
                      the enterprise ecosystem, enhancing utility for all
                      employees.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br /> We help select the ideal Office 365 plans tailored
                      to your budget, strategy, and collaboration needs.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br /> Our team plans and executes a seamless Office 365
                      migration, safeguarding your business data and processes.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Delegate all support issues to us, ensuring continuous
                      oversight and maintenance of your Office 365 deployment.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Leverage state-of-the-art Microsoft programs to boost
                      connectivity, marketing potential, and real-time team
                      collaboration.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Unlock Office 365’s full potential, utilizing cloud data
                      analytics, self-service insights, and advanced cloud PBX
                      services.
                    </span>
                  </li>
                </ul>
