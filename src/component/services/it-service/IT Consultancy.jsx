...
export const IThomePage = () => {
  ...
  const faqs = [
    {
      question: "What is IT consultancy and how can it benefit my business?",
      answer:
        "<span class='font-semibold text-indigo-600'> IT Consultancy Services </span> refer to expert guidance and solutions to optimize your business’s IT Infrastructure. Our services are designed to help you improve the efficiency of your business operations while reducing costs and enhancing security, to drive growth and innovation.",
    },
    {
      question:
    ...
    {
      question:
        "How can IT consultancy help with long-term technology planning?",
      answer:
        "Our team of experts approach each consultation with the goal of ensuring the ideas and technologies implemented are forward-thinking and take into account the business’s future expansion and escalating requirements so that your technology grows with your business.",
    },
    {
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-6 text-lg/8 text-gray-600">
              ...
              <br className="mb-4" />
              From business and technical skills to communication and
              management, you name it and we can provide it for your business
              today
            </p>
          </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-auto text-center">
            <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">
              Is your current IT infrastructure holding back your business
              growth?
            </h2>
            <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
              It's time to realign your IT strategy with your business
              objectives, ensuring your technology empowers progress.
            </p>
          </div>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              ...
              <div class="lg:pr-4">
                <div class="lg:max-w-lg">
                  <p class="text-base/7 font-semibold text-indigo-600 tracking-[.35em] uppercase">
                    Trend Analysis for Enhanced IT Security
                  </p>
                  <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-800 sm:text-5xl">
                    IT Consultancy for Optimal IT Performance
                  </h1>
                  <p class="mt-6 text-xl/8 text-gray-600">
                    {" "}
                    Enhance your business operations with expert{" "}
                    <span class=" font-semibold text-indigo-600">
                      {" "}
                      IT consultancy{" "}
                    </span>{" "}
                    tailored to achieve peak performance. We analyze,
                    strategize, and implement cutting-edge IT solutions to
                    optimize your infrastructure, streamline processes, and
                    drive efficiency. Empower your organization with technology
                    that works smarter.
                  </p>
                </div>
              </div>
                ...
                <ul class="mt-8 space-y-8 text-gray-600">
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      We create strategies and design solutions to align IT
                      resources with your business objectives effectively.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br /> Our service ensures scalable, secure IT
                      infrastructure, reducing reliance on an in-house IT team.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      We provide on-demand, proactive management of all IT
                      operations and maintenance to ensure smooth functionality.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br /> We update outdated technologies, lowering
                      maintenance costs and enhancing overall business
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      With over 50% senior-level engineers, we guarantee
                      top-tier implementation of tailored IT solutions.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br /> We boost performance, flexibility, and
                      cost-effectiveness by migrating and optimizing your
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br /> We offer comprehensive support, covering every
                      aspect of your IT needs for seamless operation and
                      success.
                    </span>
                  </li>
                </ul>
