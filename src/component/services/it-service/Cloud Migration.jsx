...
export const IThomePage = () => {
  ...
  const faqs = [
    ...
    {
      question: "How do you manage cloud scalability?",
      answer: "From the get-go, our team ensures that our proposed systems can easily be scaled as per the business’s requirements, whether you require more storage, performance or bandwidth, we make sure your infrastructure grows with you."
    },
    {
      question: "How do cloud management services support disaster recovery?",
        ...
        <div class="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
          <ul class="mt-8 space-y-8 text-gray-600">
            <li class="flex gap-x-3">
              ...
              <span><strong class="font-semibold text-gray-800">Expert Cloud Integration</strong><br/>Our team seamlessly integrates your cloud-based network with existing IT infrastructure, ensuring compatibility and optimal performance across systems.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">24/7 Access and Support</strong><br/>Access your cloud platform anytime, anywhere, with round-the-clock support. We ensure your cloud services remain consistently available and functional.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Multi-Cloud Management</strong><br/> For larger enterprises, we manage complex multi-cloud environments, optimizing resource allocation and integration across different cloud platforms.</span>
            </li>
            <li class="flex gap-x-3">
              <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Enhanced Productivity</strong><br/> Cloud migration boosts productivity by improving access and mobility for your workforce, whether they’re working remotely or from multiple locations.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Cost Savings</strong><br/>Reduce expenses on internal server storage and physical office space by leveraging cloud solutions, benefiting both small and large businesses.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Optimized Cloud Performance</strong><br/>Investing in a robust cloud manager ensures you achieve full cloud capabilities, maximizing the efficiency and performance of your cloud infrastructure.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Simplified Cloud Operations</strong><br/>With our cloud management services, you can manage your cloud resources without requiring deep IT knowledge, simplifying operations and enhancing usability.</span>
            </li>
          </ul>
