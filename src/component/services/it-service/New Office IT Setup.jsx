...
export const IThomePage = () => {
  ...
  const services = [
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/PC-Laptop.webp", name: 'PC & Laptop', isBlue: true },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/server-1.webp", name: 'Servers', isBlue: false },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/IP-Phone.webp", name: 'PABX', isBlue: true },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/switch-1.webp", name: 'Switches', isBlue: false },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/cctv-2.webp", name: 'CCTV & IT', isBlue: true },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/router-1.webp", name: 'Router', isBlue: false },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/biometric-1.webp", name: 'Access Control', isBlue: true },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/printer-1.webp", name: 'Printer', isBlue: false },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/cloud-1.webp", name: 'Cloud Subscription', isBlue: true },
    { icon: "https://cubezix.com/wp-content/uploads/2024/09/nas-drive.webp", name: 'NAS Drive', isBlue: false }
  ]
  ...
  const faqs = [
    {
      question: "What does a New Office IT Setup include?",
      answer: "Our <span class='font-semibold text-indigo-600'> New Office IT Setup Services</span> consist of a variety of operations such as network design, infrastructure installation, hardware and software deployment, security, and ongoing IT support just to name a few. Our seasoned team of experts strive to provide a comprehensive, secure, and efficient setup experience for your business."
    },
    {
      question: "What kind of hardware and software do you install?",
      answer: "We provide a comprehensive list of both hardware and software solutions including: <br/> <br/> <span class='font-semibold text-indigo-600'> Servers</span> <br/> <span class='font-semibold text-indigo-600'> Routers</span> <br/> <span class='font-semibold text-indigo-600'> Switches</span> <br/> <span class='font-semibold text-indigo-600'> Workstations</span> <br/> <span class='font-semibold text-indigo-600'> Printers</span> <br/> <span class='font-semibold text-indigo-600'> Office 365</span> <br/> <span class='font-semibold text-indigo-600'> Security Applications</span> <br/> <span class='font-semibold text-indigo-600'> Cloud & VPN Solutions</span> <br/> <br/> As well as any number of industry-specific applications as per your business requirements."
    },
    {
      question: "How long does it take to set up the IT infrastructure for a new office?",
    ...
    {
      question: "How do you ensure minimal disruption during the IT setup process?",
      answer: "Our team of experts maintain constant communication with your team in order to schedule the IT Setup processes around your operational hours, maximizing the use of non-peak times and after office hours to minimize any disruptions. We also perform constant testing of installed systems to provide peak operational capacity prior to going live."
    }
  ];
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-36">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              ...
              Tailored IT Infrastructure Design
...
<div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-auto text-center">
      <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">For New IT Office Setup</h2>
      <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">Get in touch with our team today to setup your new IT office.</p>
    </div>
    <div className="mt-10 flex items-center justify-center gap-x-6">
                <a href="/" className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
        ...
        <div class="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
          <ul class="mt-8 space-y-8 text-gray-600">
            <li class="flex gap-x-3">
              ...
              <span><strong class="font-semibold text-gray-800">IT Infrastructure Consultation</strong><br/> We assess communication systems, document requirements, and plan your office IT setup.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Structured Cabling Solutions</strong><br/> We design and install data cabling for seamless connectivity and efficient operations.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Internet and Phone Communication Systems</strong><br/>Partnering with Du and Etisalat, we deliver tailored, high-quality communication solutions.</span>
            </li>
            <li class="flex gap-x-3">
              <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Managed Wi-Fi Solutions</strong><br/> We implement strategic Wi-Fi systems for reliable connectivity and enhanced office efficiency.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Security Solution Implementation</strong><br/>We create and install robust security measures to safeguard your company's assets.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Backup Solution Implementation</strong><br/> Our backup solutions ensure secure data protection and recovery in emergencies.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Testing Your New Office Network</strong><br/>We verify installation, resolve issues, and ensure smooth connectivity from Day One.</span>
            ...
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
              ...
              <span><strong class="font-semibold text-gray-800">Cloud Subscriptions and Business Collaboration Integrations</strong><br/> We offer domain hosting, email security, and cloud services through trusted partners.</span>
            </li><li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
                stroke="currentColor"
              ...
              <span><strong class="font-semibold text-gray-800">IT AMC (Annual Maintenance Contract)</strong><br/>Our AMC provides ongoing support and troubleshooting after initial IT setup is complete.</span>
            </li>
          </ul>
...
<div className="container mx-auto px-4 py-12 pb-7 mb-32">
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-5 gap-4 sm:gap-6">
    {services.map((service, index) => (
      ...
      >
        <div
          className={`h-48 p-6 flex flex-col items-center justify-center space-y-4 rounded-lg transform -skew-x-6 ${
            service.isBlue
          ...
          <div className="transform skew-x-6">
            <img
              ...
              className={`w-12 h-12 mx-auto transition-transform group-hover:scale-110 ${
                service.isBlue ? 'text-white' : 'text-blue-500'
              }`}
            />
            <h4
      ...
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          <div key={index} className="border-b border-gray-900 pb-4">
            <div
              className="flex justify-between items-center cursor-pointer text-lg font-medium text-gray-600 hover:text-blue-500"
