  ...
  const faqs = [
    {
      ...
      answer:
        "An IT AMC is an Annual Maintenance Contract that ensures regular maintenance, support, and troubleshooting of your IT infrastructure, helping businesses operate smoothly without technical disruptions.",
    },
    {
      question: "Why do I need an IT AMC in Dubai?",
      answer:
        "Dubai’s fast-paced business environment demands robust IT systems. An IT AMC provides proactive support, minimizes downtime, and ensures optimal system performance, allowing businesses to stay competitive.",
    },
    {
      question: "What services are included in an IT AMC?",
      answer:
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-36">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-pretty text-lg font-medium text-gray-600 sm:text-xl/8">
                Get your IT Systems Up and Running with our 24/7 dedicated IT
                AMC Support.
              </p>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-6 text-lg/8 text-gray-600">
              ...
              maintenance. We provide cost-effective and scalable IT AMC in
              Dubai. Our IT Annual Maintenance Contract in Dubai covers
              everything that your business needs. 24/7 dedicated L1, L2, L3 IT
              support engineers.
            </p>
          </div>
              ...
              <div class="lg:pr-4">
                <div class="lg:max-w-lg">
                  ...
                  <p class="mt-6 text-xl/8 text-gray-600">
                    ...
                    innovation, structuring transformation, and unlocking growth
                    for your company.
                  </p>
                </div>
              </div>
                ...
                <ul class="mt-8 space-y-8 text-gray-600">
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      prevention, we deliver 24/7 support for networks, servers
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      within our system to ensure your company’s data recovery,
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      IT Professionals to eliminate the risk and worries while
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Our expert team provides robust defense strategies,
                      real-time threat monitoring, and proactive incident
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      such as slow operations, or even regularly crashing. Our
                      IT AMC services help you sort out.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div class="mx-auto text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <p class="mt-6 text-pretty text-lg/8 text-gray-300">
                ...
                Dubai, UAE. With a team of highly experienced, skilled, and
                certified IT Support engineers, we possess the capability to
                cater to the diverse needs of companies through our IT Annual
