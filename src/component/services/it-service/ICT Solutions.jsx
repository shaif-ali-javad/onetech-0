...
export const IThomePage = () => {
  ...
  const faqs = [
    {
      question: "What are ICT solution services?",
    ...
    {
      question: "Do you offer cloud-based ICT solutions?",
    ...
    },
    {
      ...
      answer: "The overall cost of implementing ICT solutions varies from business to business, with the cost dependent upon various factors such as the scale and complexity of the project, however, to help offset this, we offer flexible pricing plans customized to fit your business's unique requirements & budget."
    },
    {
      question: "Do you offer ongoing training for new ICT systems?",
      answer: "Of course, we offer a comprehensive training program and documentation to ensure that your team is comfortable with any newly implemented systems or hardware in order to maximize the benefits of the infrastructure."
    }
  ];
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-36">
            ...
            <div className="text-center">
              <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-800 sm:text-7xl">ICT Solutions in Dubai</h1>
              <p className="mt-8 text-pretty text-lg font-medium text-gray-600 sm:text-xl/8">From IT infrastructure to communication networks, we provide tailored services that meet the unique demands of businesses in Dubai</p>
      ...
      <div class="relative lg:row-span-2">
        ...
        <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)] pb-8">
          <div class="px-8 pb-3 pt-8 sm:px-10 sm:pb-5 sm:pt-10">
            ...
            <p class="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">Expert Consultancy and Seamless Implementation for Optimal Office IT Solutions</p>
...
<div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-auto text-center">
      <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Ready to Enhance Your IT Systems?</h2>
      <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">Boost your business with advanced ICT solutions</p>
    </div>
    <div className="mt-10 flex items-center justify-center gap-x-6">
                <a href="/" className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
        ...
        <div class="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
          <ul class="mt-8 space-y-8 text-gray-600">
            <li class="flex gap-x-3">
              ...
              <span><strong class="font-semibold text-gray-800">Improved Efficiency</strong><br/> ICT solutions streamline business processes, enabling smoother operations and faster workflows.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Enhanced Security</strong><br/>With advanced cybersecurity measures, ICT solutions protect your business from online threats and data breaches.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Strong Encryption</strong><br/>Create secure, encrypted connections between endpoints to protect sensitive data from unauthorized access.</span>
            </li>
            <li class="flex gap-x-3">
              <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Scalability for Growth</strong><br/> Our solutions are designed to grow with your business, ensuring you can easily scale your IT systems</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Cost-Effective Solutions</strong><br/>ICT services help reduce operational costs by automating tasks and optimizing resource usage.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">Better Communication</strong><br/> Integrated communication systems allow for seamless collaboration and improved team coordination across your organization.</span>
            </li>
            <li class="flex gap-x-3">
            <svg class="mt-1 size-5 flex-none text-indigo-600" fill="none"
                viewBox="0 0 20 25"
              ...
              <span><strong class="font-semibold text-gray-800">24/7 Support</strong><br/> Our technical support team is available around the clock, ensuring that any issues are resolved quickly and efficiently.</span>
            </li>
          </ul>
