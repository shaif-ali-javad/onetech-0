...
export const IThomePage = () => {
  ...
  const faqs = [
    {
      question:
        "What is SIRA, and why do I need SIRA approval for CCTV installation?",
      answer:
    ...
    {
      question:
        "How long does the SIRA approval process take for CCTV installation?",
      answer:
        "The timeline for SIRA approval can vary depending on the complexity of your security system. Typically, the process can take a few days to a couple of weeks, but we handle all the paperwork and certification to ensure a smooth process.",
    },
    {
      question:
    ...
    {
      question:
        "What types of businesses require SIRA-approved CCTV installations?",
      answer:
        "All businesses in Dubai are required to install SIRA-approved security systems, especially those in high-risk industries like banking, retail, healthcare, and commercial properties. Compliance with SIRA ensures your business meets local security laws.",
    },
    {
      question:
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-36">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-pretty text-lg font-medium text-gray-600 sm:text-xl/8">
                As a SIRA-approved company, we provide professional consultancy
                and certification services, ensuring your security systems meet
                the top industry standards
              </p>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-800 sm:text-5xl lg:text-balance">
              SIRA Certification Services in Dubai
            </p>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-auto text-center">
            <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">
              Get SIRA-Approved CCTV Installation Now
            </h2>
            <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
              SIRA-approved consultancy and certification services, guaranteeing
              full compliance and top-tier protection.
            </p>
          </div>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              ...
              <div class="lg:pr-4">
                <div class="lg:max-w-lg">
                  ...
                  <p class="mt-6 text-xl/8 text-gray-600">
                    A SIRA-approved CCTV installation ensures that your security
                    system complies with Dubai’s strict security standards.
                  </p>
                </div>
              </div>
            </div>
                ...
                <ul class="mt-8 space-y-8 text-gray-600">
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      SIRA-compliant systems provide state-of-the-art
                      protection, reducing risks and enhancing security.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      SIRA certification ensures your business follows all local
                      security regulations, avoiding penalties.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />A certified security system reflects positively on
                      your business, increasing trust with clients and partners.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Proper CCTV installation lowers liability risks, offering
                      peace of mind in the event of security incidents.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Our experienced team ensures that installations are
                      flawless, meeting both your needs and regulatory
                      requirements.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      We offer maintenance and support services to ensure your
                      system remains compliant and fully operational.
                    </span>
                  </li>
                </ul>
              </div>
