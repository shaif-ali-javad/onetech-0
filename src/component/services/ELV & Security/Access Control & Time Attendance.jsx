  ...
  const faqs = [
    {
      ...
      answer:
        "An <span class=' font-semibold text-indigo-600'> Access Control System </span> is a type of security solution to control who can access specific parts of a business’s building or network. Typically, this involves the use of keycards, biometrics, or PIN codes to grant controlled access to ensure business security and integrity.",
    },
    {
      question:
        "How can access control systems improve security for my business?",
      answer:
        "By granting & restricting direct access to certain sections of a company’s network or premises, access control systems ensure that only personnel that are approved can access the appropriate areas. Additionally, access control systems keep a record of who accessed what and when; thereby allowing for simplified tracking and auditing, which adds an additional layer of accountability.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer:
        "The cost of an access control system is dependent upon numerous factors including: <br/> <br/> <span class=' font-semibold text-indigo-600'> No. of Entry Points</span> <br/> <span class=' font-semibold text-indigo-600'> Type of security system (PIN, Biometric, etc)</span> <br/> <span class=' font-semibold text-indigo-600'> No. of employees and roles</span> <br/> <span class=' font-semibold text-indigo-600'> Integration with existing systems</span> <br/> <br/> Following a thorough assessment of your requirements, our team will then provide a custom quote that aligns with your business needs and budget",
    },
  ];
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-36">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-800/10 hover:ring-gray-800/20 tracking-[.35em] uppercase">
                Secure and Efficient Solutions for Your Office
            ...
            <div className="text-center">
              <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-800 sm:text-7xl">
                Advanced Access Control Systems in Dubai
              </h1>
              <p className="mt-8 text-pretty text-lg font-medium text-gray-600 sm:text-xl/8">
                Cutting-edge access control systems in Dubai, offering
                cost-effective solutions to ensure safety and security for your
                office premises.
              </p>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:text-center">
            <h2 class="text-base/7 font-semibold text-indigo-600 tracking-[.35em] uppercase">
              Biometric Access Control Systems in Dubai
            </h2>
            ...
            <p class="mt-6 text-lg/8 text-gray-600">
              Providing advanced Access Control and Time Attendance solutions
              that enhance security and streamline workforce management. Our
              services include the installation and maintenance of biometric
              systems, card access systems, and integrated time-tracking
              software.
            </p>
          </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-auto text-center">
            <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">
              Get Access Control System in Dubai
            </h2>
            <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
              Get in touch with our team today for Access Control System
              Services
            </p>
          </div>
          <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <div class="lg:pr-4">
                <div class="lg:max-w-lg">
                  ...
                  <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-800 sm:text-5xl">
                    Advanced Solutions for Secure and Efficient Facility
                    Management
                  </h1>
                  <p class="mt-6 text-xl/8 text-gray-600">
                    ...
                    , from single-door solutions to integrated multi-door
                    systems, ensuring secure facility access.
                  </p>
                </div>
              </div>
            </div>
                ...
                <ul class="mt-8 space-y-8 text-gray-600">
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Stand-alone solutions for secure access to individual
                      doors with straightforward management and installation.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Integrated systems controlling multiple doors across
                      various facilities, ideal for complex security needs.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      Efficient and scalable RFID systems for secure, long-range
                      access with easy tracking and management.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    <svg
                    ...
                    <span>
                      ...
                      <br />
                      RFID-based solutions for automated vehicle access,
                      including long-range readers and parking management
                      integration.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Pedestrian turnstiles and speed gates offering
                      high-security barriers with advanced anti-panic and
                      durability features.
                    </span>
                  </li>
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      <strong class="font-semibold text-gray-800">
                        Web-Based Access Software
                      </strong>
                      <br />
                      Comprehensive management software for controlling access
                      times, credentials, and real-time monitoring with
                  ...
                  <li class="flex gap-x-3">
                    ...
                    <span>
                      ...
                      <br />
                      Systems combining various access control technologies,
                      including biometric and card-based methods, for robust
          ...
          <div class="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div class="mx-auto text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              <h2 class=" text-base/7 font-semibold text-indigo-600 tracking-[.35em] mb-3 uppercase">
                Web-based Access Soft supports
              </h2>
              ...
              <p class="mt-6 text-pretty text-lg/8 text-gray-300">
                ...
                ability to manage credentials—including enrollment, activation,
                and expiration—our solution ensures effective user management.
                We support hybrid cards and formats (HID/Custom), providing
                flexibility for your access needs. Our Escort Visitor
                functionality enhances security for guests, while the ability to
                create doors, door groups, holidays, and schedules allows for
                customized access control tailored to your operations.
              </p>
            ...
            <div class="relative mt-16 h-80 lg:mt-8">
              <img
                ...
                src="https://cubezix.com/wp-content/uploads/2024/02/Access-Control.webp"
                alt="App screenshot"
                width="1824"
                height="1080"
              />
